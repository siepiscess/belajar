...
<div class="container-trans" style="max-width:1140px; margin-top:38px;">
  ...
  <div id="produkTab" class="tab-content" style="display:block;">
    ...
    <table class="table-admin">
      <thead>
        <tr>
          <th>Id</th><th>Nama</th><th>Harga</th><th>Stok</th><th>Image</th><th>Kategori</th><th>Action</th>
        </tr>
      </thead>
      <tbody>
  ...
  <div id="pesananTab" class="tab-content" style="display:none;">
    <table class="table-admin">
      <thead>
        <tr>
          <th>Id</th><th>Nama Orang</th><th>Alamat</th><th>Nama Aglo</th><th>Size</th><th>Ukuran</th><th>Action</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr data-id="<?= $row['id']?>">
          <td><?= $row['id']?></td>
          <td><?= htmlspecialchars($row['nama_orang']) ?></td>
          <td><?= htmlspecialchars($row['alamat']) ?></td>
          <td><?= htmlspecialchars($row['nama_aglo']) ?></td>
